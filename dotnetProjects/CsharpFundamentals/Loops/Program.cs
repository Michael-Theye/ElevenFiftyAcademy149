...
string[] students = {"Mikey T", "David", "Cassandra", "Clarissa"};
...
do
{
    System.Console.WriteLine("this should no show");
}
while (false);
...
do
{
  System.Console.WriteLine($"I have {counting} finger");
  counting++;
}
while (counting < 11);
do
{
  System.Console.WriteLine(value: "I have all 10 fingers");
}
while (false);
